...
bg `#EEF3F8` · surface `#FFFFFF` · surface-2 `#F6F8FB` · title `#183153` · fg `#4B5D73` · fg-2 `#626F81` · fg-muted `#67707A`
primary `#2E71B4` · primary-strong `#1F5E9D` · accent `#896A25` · success `#4FA66A` · warning `#D0882E` · attention `#8A96A6` · danger `#D45B4F` · info `#4A91C9`
seq-1..5：`#E6F0FA` · `#C7DDF2` · `#8FB9E2` · `#4F8DCC` · `#1F5E9D`（纯蓝明度台阶，不混绿/金）

**dark** `gov-finance-blue-dark`
bg `#0F2036` · surface `#16304F` · surface-2 `#1E3C61` · title `#EAF1F8` · fg `#C6D3E2` · fg-2 `#9DB0C6` · fg-muted `#98A6B7`
primary `#74AADC` · primary-strong `#7FB4E2` · accent `#E0B452` · success `#5FB87C` · warning `#DDA445` · danger `#DD6E62` · info `#6BA8DE`
...
## 砂绿 sage（仅 light）
bg `#EFEAE0` · surface `#E5DFD2` · surface-2 `#DBD4C5` · title `#1A1A1A` · fg `#3A382F` · fg-2 `#5E5D51` · fg-muted `#5E5C52`
primary `#4B614E` · primary-strong `#48614C` · accent `#894A30` · seq `#D7E1D7`·`#BDCEC0`·`#95B099`·`#6B8A6F`·`#4E6A52`
**适合**：通用汇报、经营报告、内部说明。**注意**：标志橙只点最关键 1–2 处，结构用鼠尾草同色阶。

## 蓝天绿地 sky-field / sky-field-dark
**light** primary `#3271A6` · accent `#A5564F`（珊瑚）· danger `#B23648`（深红）· seq `#E1F3FA`→`#285C86`
**dark** `sky-field-dark` primary `#6BA7D4` · accent `#E08A80` · seq `#21425E`→`#A9D2EA`
**适合**：管理看板、风险提醒、复盘分析。**注意**：`--danger` 深红只用于真正严重异常，普通待办用 `--warning`/`--attention`。

## 夏日海滩 summer-coast（仅 light）
primary `#2C7193` · accent `#A6513D`（珊瑚）· seq `#CDEBEA`→`#2C77A0`
**适合**：客户活动页、领奖提醒、操作指引。**不适合**：正式经营看板（太暖太活泼）。

## 暖砂 warm-sand（仅 light）
primary `#42697D`（蓝灰）· accent `#8D535F`（粉）· seq `#CBD9DE`→`#355A68`
